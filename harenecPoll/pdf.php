...
if (isset($_SESSION['manual_content'])) {
    ...
    $pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, 'Curiosity hub', 'Autori: Juraj, Boris, Jozef, Tomáš');
    ...
    $heading = '<h2 style="text-align: center">Používateľská príručka</h2><br>';
